...
namespace ASPNETIdentityManager.Controllers
{
    public class HomeController : Controller
    {
        ...
        public IActionResult GestisciPrenotazioni([FromServices] PrenotazioneDBContext dBContext)
        {
            PrenotazioneModel model = new PrenotazioneModel();
            model.Prenotazione = dBContext.Prenotazione.Select(u => new Prenotazione()
            {
                ID = u.Id,
                UserName = u.UserName,
                Dal = u.Dal,
